...
async function seedUser(req, res) {
  try {
    ...
    // console.log("users after saved",users)

    let userIds = await users.map((user) => user._id);
    ...
    posts = await Promise.all(
        posts.map((post, index) =>  {
          return new Post({
            ...
            author: userIds[index],
          }).save();
        })
      );

    // await Post.insertMany(posts);
    console.log("Past after saved",posts)
    let postIds = await posts.map((post) => post._id);
    
    console.log("post id after saved",postIds)
    ...
    let comments = [
      ...
      {
        content: "Comment 2 on Post 2",
        author: "user_id_2",
        post: "post_id_2",
      },
      {
        content: "Comment 3 on Post 3",
        author: "user_id_3",
        post: "post_id_3",
      },
      {
      ...
      {
        content: "Comment 5 on Post 5",
        author: "user_id_5",
        post: "post_id_5",
      },
      {
        content: "Comment 6 on Post 6",
        author: "user_id_6",
        post: "post_id_6",
      },
      {
        content: "Comment 7 on Post 7",
        author: "user_id_7",
        post: "post_id_7",
      },
      {
        content: "Comment 8 on Post 8",
        author: "user_id_8",
        post: "post_id_8",
      },
      {
        content: "Comment 9 on Post 9",
        author: "user_id_9",
        post: "post_id_9",
      },
      {
        content: "Comment 10 on Post 10",
        author: "user_id_10",
        post: "post_id_10",
      },
      {
        content: "Comment 11 on Post 11",
        author: "user_id_11",
        post: "post_id_11",
      },
      {
        content: "Comment 12 on Post 12",
        author: "user_id_12",
        post: "post_id_12",
      },
      {
        content: "Comment 13 on Post 13",
        author: "user_id_13",
        post: "post_id_13",
      },
      {
        content: "Comment 14 on Post 14",
        author: "user_id_14",
        post: "post_id_14",
      },
      {
        content: "Comment 15 on Post 15",
        author: "user_id_15",
        post: "post_id_15",
      },
      {
        content: "Comment 16 on Post 16",
        author: "user_id_16",
        post: "post_id_16",
      },
      {
        content: "Comment 17 on Post 17",
        author: "user_id_17",
        post: "post_id_17",
      },
      {
        content: "Comment 18 on Post 18",
        author: "user_id_18",
        post: "post_id_18",
      },
      {
        content: "Comment 19 on Post 19",
        author: "user_id_19",
        post: "post_id_19",
      },
      {
        content: "Comment 20 on Post 20",
        author: "user_id_20",
        post: "post_id_20",
      },
    ];

    // comments = postIds.flatMap((postId, index) =>
    //   userIds.map((userId) => ({
    //     content: `Comment by user ${index + 1} on Post ${index + 1}`,
    //     author: userId[index],
    //     post: postId[index],
    //   }))
    // );
    ...
    res.json({ success: "data created" });
  } catch (err) {
    console.log("sdhjfkghi", err.message);
